...
export default async function MyTicketDetailsPage({
  ...
  return (
    <div className="flex flex-col gap-8 w-full animate-in fade-in duration-500 pb-16">
      ...
      <div
        className={cn(
          "relative rounded-3xl overflow-hidden p-8 lg:p-10 bg-gradient-to-br border border-border/30",
          theme.hero,
        )}
      >
          ...
          <div>
            ...
            <div className="flex items-center gap-3 flex-wrap">
              <Badge
                variant="outline"
                className={cn(
                  "uppercase text-[10px] font-bold tracking-widest px-3 py-1 rounded-full",
                  theme.badge,
                )}
              >
      ...
      <div className="max-w-4xl w-full">
        ...
        >
          ...
          <div
            className={cn(
              "absolute top-0 left-0 right-0 h-px bg-gradient-to-r opacity-50",
              theme.stripe,
            )}
          />
          ...
          <div
            className={cn(
              "absolute top-0 left-0 bottom-0 w-px bg-gradient-to-b opacity-40",
              theme.stripe,
            )}
          />
        ...
        <p className="text-center text-xs text-muted-foreground/50 mt-4">
          💡 Save your QR code offline to ensure smooth entry even without
          internet access.
        </p>
      </div>
    </div>
